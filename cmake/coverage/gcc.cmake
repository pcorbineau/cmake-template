...
string(REGEX REPLACE "^.*g\\+\\+-([0-9]+)$" "gcov-\\1" GCOV_EXECUTABLE "${CMAKE_CXX_COMPILER}")
if(NOT GCOV_EXECUTABLE MATCHES "^gcov-[0-9]+$")
	set(GCOV_EXECUTABLE gcov)
endif()
find_program(GCOV_EXECUTABLE_PATH NAMES ${GCOV_EXECUTABLE} gcov)
message(STATUS "Using gcov: ${GCOV_EXECUTABLE_PATH}")

set(COVERAGE_C_FLAGS --coverage -fkeep-inline-functions)
set(COVERAGE_CXX_FLAGS --coverage -fkeep-inline-functions)
