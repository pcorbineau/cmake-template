...
if(NOT LLVM_COV_EXECUTABLE)
	message(FATAL_ERROR "llvm-cov not found. Please install llvm-cov to use code
	coverage with Clang.")
	return()
endif()
find_program(
...
if(NOT LLVM_PROFDATA_EXECUTABLE)
	message(FATAL_ERROR "llvm-profdata not found. Please install llvm-profdata to use code
	coverage with Clang.")
	return()
endif()
...
add_custom_target(
		coverage
		COMMAND ${CMAKE_COMMAND} -E env LLVM_PROFILE_FILE=${CMAKE_BINARY_DIR}/coverage.profraw $<TARGET_FILE:${coverage_target}>
		...
		COMMAND ${LLVM_COV_EXECUTABLE} show
			-object $<TARGET_FILE:${coverage_target}>
			-format=html
