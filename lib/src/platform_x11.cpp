...
auto X11Traits::create(WindowConfig cfg) -> Handle {
  ...
  XColor xcolor{};
  xcolor.red = static_cast<unsigned short>(static_cast<int>(cfg.background_color.red * 65535.0));
  xcolor.green = static_cast<unsigned short>(static_cast<int>(cfg.background_color.green * 65535.0));
  xcolor.blue = static_cast<unsigned short>(static_cast<int>(cfg.background_color.blue * 65535.0));
...
auto X11Traits::set_background_color(Handle &handle, BackgroundColor color) -> void {
  ...
  XColor xcolor{};
  xcolor.red = static_cast<unsigned short>(static_cast<int>(color.red * 65535.0));
  xcolor.green = static_cast<unsigned short>(static_cast<int>(color.green * 65535.0));
  xcolor.blue = static_cast<unsigned short>(static_cast<int>(color.blue * 65535.0));
  xcolor.flags = DoRed | DoGreen | DoBlue;
